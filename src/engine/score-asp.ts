...
const RUBRIC_PATH = resolve(__dirname, "../../rules/asp-rubric.json");
...
export function processASP(targetId: string, fetchedData: FetchedData): ScanResult {
